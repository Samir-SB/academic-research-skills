...
\textbf{Definition 1: Moving Crowdsourced Service MS} \hyperlink{cite.neiat2021}{[1]}. A moving
...
\textbf{Definition 2: User Trajectory \(T_u\)} \hyperlink{cite.neiat2021}{[1]}. A user trajectory is the
path traveled by a user, defined as a set of \(k\) timestamped samples:
\[T_u = \{\langle u_{t_i}, u_{x_i}, u_{y_i} \rangle\}\]

\textbf{Definition 3: Spatial Candidate Pair} \hyperlink{cite.neiat2021}{[1]}. Given a set of moving
...
\textbf{Definition 4: Valid Candidate Moving Service} \hyperlink{cite.neiat2021}{[1]}. A moving service
...
\textbf{Problem Definition} \hyperlink{cite.neiat2021}{[1]}: Given a set of moving crowdsourced services
...
\textbf{Assumptions} \hyperlink{cite.neiat2021}{[1]}: - One moving service can only serve one user at
...
\textbf{MDP Formulation}: We formulate this as an MDP, following the exact structure from prior work \hyperlink{cite.neiat2021}{[1]}.
...
\textbf{Handling Edge Cases} \hyperlink{cite.neiat2021}{[1]}:
...
We use a dense fully connected neural network to train our model, following the exact architecture from prior work \hyperlink{cite.neiat2021}{[1]}:
