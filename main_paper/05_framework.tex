...
\textbf{Definition 1: Moving Crowdsourced Service MS} {[}1{]}. A moving
...
\textbf{Definition 2: User Trajectory \(T_u\)} {[}1{]}. A user trajectory is the
path traveled by a user, defined as a set of \(k\) timestamped samples:
\[T_u = \{\langle u_{t_i}, u_{x_i}, u_{y_i} \rangle\}\]

\textbf{Definition 3: Spatial Candidate Pair} {[}1{]}. Given a set of moving
...
\textbf{Definition 4: Valid Candidate Moving Service} {[}1{]}. A moving service
...
\textbf{Problem Definition} {[}1{]}: Given a set of moving crowdsourced services
...
\textbf{Assumptions} {[}1{]}: - One moving service can only serve one user at
