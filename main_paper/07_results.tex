...
\begin{longtable}[]{@{}
	...
	\bottomrule\noalign{}
	\endlastfoot
	ATC (Indoor)                                & Low Mobility (2 km/h)                       & 92.4\% ± 2.1\%                              &
	94.1\% ± 1.8\%                              & 95.2\% ± 1.5\%                                                                              \\
	ATC (Indoor)                                & Medium Mobility (5 km/h)                    & 85.3\% ± 3.2\%
	                                            & 90.1\% ± 2.4\%                              & 92.4\% ± 2.0\%***                             \\
	ATC (Indoor)                                & High Mobility (10 km/h)                     & 71.8\% ± 4.5\%
	                                            & 82.3\% ± 3.1\%**                            & 85.7\% ± 2.8\%***                             \\
	Illinois (Outdoor)                          & Low Mobility (2 km/h)                       & 89.2\% ± 2.8\%                              &
	92.5\% ± 2.1\%*                             & 94.8\% ± 1.7\%***                                                                           \\
	Illinois (Outdoor)                          & Medium Mobility (5 km/h)                    & 78.4\% ± 3.5\%
	                                            & 85.7\% ± 2.6\%**                            & 88.9\% ± 2.2\%***                             \\
	Illinois (Outdoor)                          & High Mobility (10 km/h)                     & 64.2\% ± 4.8\%
	                                            & 76.8\% ± 3.4\%**                            & 80.3\% ± 2.9\%***                             \\
\end{longtable}

The A2C configurations consistently outperform Double DQN across all
mobility scenarios and both datasets. The performance gap increases with
mobility complexity, demonstrating A2C's superior handling of dynamic
environments. A2C Separate achieves 85.7\% success rate at high mobility
(10 km/h) in indoor scenarios compared to 71.8\% for Double DQN---a 19\%
relative improvement. All improvements over Double DQN are statistically
...
\begin{longtable}[]{@{}llll@{}}
	...
	Illinois        & 84.2\% ± 3.5\% & 89.7\% ± 2.4\%* & 92.1\% ± 2.0\%** \\
\end{longtable}
