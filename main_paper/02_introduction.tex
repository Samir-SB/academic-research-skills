...
co-movement patterns between the user and service trajectories [22]. We
propose spatio-temporal filtering to find services that overlap with the
user trajectory in both space and time [23].
...
ensure continuity [24]. This is fundamentally different from static
composition where services remain available throughout [27].
...
time [25]. A service might be within communication range at one instant and
outside it the next. Quality metrics like channel capacity depend on
distance, which changes as services move [29]. This dynamic nature
