...
co-movement patterns between the user and service trajectories [21]. We
propose spatio-temporal filtering to find services that overlap with the
user trajectory in both space and time [22].
...
ensure continuity [23]. This is fundamentally different from static
composition where services remain available throughout [26].
...
time [24]. A service might be within communication range at one instant and
outside it the next. Quality metrics like channel capacity depend on
distance, which changes as services move [28]. This dynamic nature
