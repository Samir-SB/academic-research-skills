...
sharing through smartphones \hyperlink{cite.neiat2021}{\hyperlink{cite.neiat2021}{[1]}}. This type of crowdsourced IoT service is
...
spatial location: fixed and moving \hyperlink{cite.neiat2021}{\hyperlink{cite.neiat2021}{[1]}}. A fixed crowdsourced service refers
...
co-movement patterns between the user and service trajectories \hyperlink{cite.gudmundsson2006}{\hyperlink{cite.gudmundsson2006}{[2]}}. We
propose spatio-temporal filtering to find services that overlap with the
user trajectory in both space and time \hyperlink{cite.jeung2008}{\hyperlink{cite.jeung2008}{[3]}}.
...
ensure continuity \hyperlink{cite.neiat2015}{\hyperlink{cite.neiat2015}{[4]}}. This is fundamentally different from static
composition where services remain available throughout \hyperlink{cite.deng2016}{\hyperlink{cite.deng2016}{[5]}}.
...
expensive indexing \hyperlink{cite.zhang2015}{\hyperlink{cite.zhang2015}{[6]}}.
...
time \hyperlink{cite.deng2017}{\hyperlink{cite.deng2017}{[7]}}. A service might be within communication range at one instant and
outside it the next. Quality metrics like channel capacity depend on
distance, which changes as services move \hyperlink{cite.zhang2015}{\hyperlink{cite.zhang2015}{[6]}}. This dynamic nature
...
adaptation \hyperlink{cite.gai2018}{\hyperlink{cite.gai2018}{[8]}}.
...
Prior work addressed this with Double DQN \hyperlink{cite.neiat2021}{\hyperlink{cite.neiat2021}{[1]}}, using the STR model
...
mobility (10 km/h), with frequent re-compositions needed \hyperlink{cite.neiat2021}{\hyperlink{cite.neiat2021}{[1]}}. However,
DQN's value-based nature has three key limitations \hyperlink{cite.gai2018}{\hyperlink{cite.gai2018}{[8]}}. First,
...
\textbf{Our Contributions}: This work makes four key contributions: (1) We adapt A2C for moving IoT service composition, building upon the STR-based selection from prior work \hyperlink{cite.neiat2021}{\hyperlink{cite.neiat2021}{[1]}} while replacing Double DQN with A2C; (2) We implement and compare two network architectures; (3) We evaluate on real GPS datasets; (4) We analyze scalability with convergence within 350-500 episodes and 44% reduction in re-composition frequency.

We pose four research questions:

\begin{enumerate}
	\item How can A2C be adapted for moving IoT service composition while
	      building upon the STR-based selection from prior work \hyperlink{cite.neiat2021}{\hyperlink{cite.neiat2021}{[1]}}?
