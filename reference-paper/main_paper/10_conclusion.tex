...
spatio-temporal constraints, building upon the STR-based selection from prior work [1]. We compared shared and separate network architectures on the
...
\begin{enumerate}
	\item
	      ...
	      coordinate state representation (r, cosθ, sinθ) effectively captures
