...
A2C outperforms Double DQN on moving IoT service composition while building upon the STR-based selection from prior work [1]. Three factors drive improvements.
